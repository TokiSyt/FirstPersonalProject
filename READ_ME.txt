This will be my first personal project from zero. 

It will be a small demo for my capstone project, which will be an App made with 3 different languages (this one will only use 1).
...
- Wheel.
: Let's you choose a stored list of names that you can edit and will output a certain amount of them, 1 by default. There will be the option to have it pop the output from the list or not.
